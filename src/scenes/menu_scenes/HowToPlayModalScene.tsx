...
class HowToPlayModalScene extends Phaser.Scene {
  constructor() {
    super({ key: "HowToPlayModalScene" });
  }
  ...
  create() {
    ...
    this.add
      .text(centerX, centerY, "Instructions go here...", {
        fontSize: "24px",
        align: "center",
        fontFamily: "VT323",
      })
    ...
    this.add
      .text(sceneWidth - 140, sceneHeight - 20, "press any button to exit", {
        fontSize: "24px",
        align: "center",
        fontFamily: "VT323",
      })
...
export default HowToPlayModalScene;
